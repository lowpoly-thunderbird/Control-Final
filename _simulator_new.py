...
class ActuatorPosition_new(ActuatorMotor_new):
...
class ActuatorVelocity_new(ActuatorMotor_new):
...
class Simulator_new:
    ...
    def _init_default_actuators(self) -> None:
        ...
        self.actuator_configs: Dict[str, ActuatorMotor_new] = {}
        for name in self.joint_names:
            self.actuator_configs[name] = ActuatorMotor_new(torque_range=default_ranges[name])
    ...
    def update_actuator(self, actuator_id: Union[str, int], actuator: ActuatorMotor_new) -> None:
    ...
    def configure_actuators(self, config: Dict[str, ActuatorMotor_new]) -> None:
